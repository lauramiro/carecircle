...
drop policy if exists "Group members can view weekly digests" on public.weekly_digests;
...
drop policy if exists "Group members can view insight cards" on public.insight_cards;
...
drop policy if exists "Users can view their own dismissals" on public.user_insight_dismissals;
create policy "Users can view their own dismissals"
on public.user_insight_dismissals for select
using (auth.uid() = user_id);

drop policy if exists "Users can dismiss their own insights" on public.user_insight_dismissals;
